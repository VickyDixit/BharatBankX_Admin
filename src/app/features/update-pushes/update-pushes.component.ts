...
// import { UpdatePushesService } from '../../core/services/...';

@Component({
  selector: 'app-update-pushes',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './update-pushes.component.html',
  styleUrl: './update-pushes.component.scss'
})
export class UpdatePushesComponent implements OnInit {
  items: any[] = [];
  filtered: any[] = [];
  paginated: any[] = [];
  loading = false;
