...
// import { MasterWorkflowsService } from '../../core/services/...';

@Component({
  selector: 'app-master-workflows',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './master-workflows.component.html',
  styleUrl: './master-workflows.component.scss'
})
export class MasterWorkflowsComponent implements OnInit {
  items: any[] = [];
  filtered: any[] = [];
  paginated: any[] = [];
  loading = false;
