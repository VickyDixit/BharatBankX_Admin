...
// import { DeviceLocksService } from '../../core/services/...';

@Component({
  selector: 'app-device-locks',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './device-locks.component.html',
  styleUrl: './device-locks.component.scss'
})
export class DeviceLocksComponent implements OnInit {
  items: any[] = [];
  filtered: any[] = [];
  paginated: any[] = [];
  loading = false;
