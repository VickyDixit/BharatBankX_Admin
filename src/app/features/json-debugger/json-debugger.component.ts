...
// import { JsonDebuggerService } from '../../core/services/...';

@Component({
  selector: 'app-json-debugger',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './json-debugger.component.html',
  styleUrl: './json-debugger.component.scss'
})
export class JsonDebuggerComponent implements OnInit {
  items: any[] = [];
  filtered: any[] = [];
  paginated: any[] = [];
  loading = false;
