...
// import { WorkflowTransactionsService } from '../../core/services/...';

@Component({
  selector: 'app-workflow-transactions',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './workflow-transactions.component.html',
  styleUrl: './workflow-transactions.component.scss'
})
export class WorkflowTransactionsComponent implements OnInit {
  items: any[] = [];
  filtered: any[] = [];
  paginated: any[] = [];
  loading = false;
